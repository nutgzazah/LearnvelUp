...
const LOSE_QUOTES = [
  "ฮ่าๆๆ! แค่นี้ยังทำอะไรฉันไม่ได้หรอกนะ กลับไปฝึกมาใหม่! 🐊⚔️",
  "อ่อนหัดนัก! ดาบของฉันยังไม่ได้ออกแรงเลยนะ 🗡️",
  "โธ่เอ๊ย นึกว่าจะแน่! ถอยไปตั้งหลักก่อนเถอะ 🦦💦",
  "ฮี่ๆ! ทางนี้ยังสบายๆ อยู่เลยนะ รอบหน้าเอาให้ตึงกว่านี้หน่อย! 🛡️",
  "ยังเร็วไปร้อยปีที่จะมาโค่นฉัน! ลุกขึ้นมาสู้ใหม่สิ! 😤",
];

const WIN_QUOTES = [
  "ยอมแพ้แล้วจ้า! แข็งแกร่งเกินไปแล้ว ไม่ไหวๆ 🏳️",
  "อูยยย... ไม่นึกเลยว่านากจะเก่งขนาดนี้ ฝากไว้ก่อนเถอะ! 😵‍💫",
  "พอแล้วๆ ฉันขอยกธงขาว! เชิญผ่านไปได้เลย 🤕",
  "แพ้ราบคาบ... ดาบฉันสู้ความรู้ของเธอไม่ได้เลย 🐊💦",
  "โอ๊ยยย มึนหัวไปหมดแล้ว! เอาชัยชนะไปเลยคนเก่ง 💫",
];
